...
) ENGINE = InnoDB AUTO_INCREMENT = 39099 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `account_receivables`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 54601 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `inventory_restockings`  (
  ...
  `branch_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 154501487 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for payment_tenders_credit_memo
-- ----------------------------
DROP TABLE IF EXISTS `payment_tenders_credit_memo`;
CREATE TABLE `payment_tenders_credit_memo`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `payment_id` int(11) NOT NULL,
  `amount` decimal(18, 2) NULL DEFAULT NULL,
  `paytrans_date` datetime(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `payment_id`(`payment_id`) USING BTREE,
  CONSTRAINT `payment_tenders_credit_memo_ibfk_1` FOREIGN KEY (`payment_id`) REFERENCES `payment_tenders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sales_return_items`  (
  ...
  `item_total_amount` decimal(18, 2) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
