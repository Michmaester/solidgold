...
) ENGINE = InnoDB AUTO_INCREMENT = 23193 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `account_receivables`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4413 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for customers_copy1
-- ----------------------------
DROP TABLE IF EXISTS `customers_copy1`;
CREATE TABLE `customers_copy1`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `customer_ref` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `inventory_restockings`  (
  ...
  `branch_code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60471614 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `payment_purchase_orders`  (
  ...
  `cash_amount` decimal(18, 2) NULL DEFAULT NULL,
...
CREATE TABLE `payment_tenders_cheque`  (
  ...
  `cheque_date` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `purchase_order_items`  (
  ...
  `quotation_price` decimal(10, 2) NULL DEFAULT NULL,
  ...
  `receive_encoder` int(255) NULL DEFAULT NULL,
...
CREATE TABLE `sales_deliveries`  (
  ...
  `invoice_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `delivery_requested_date` datetime(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for stocks_copy1
-- ----------------------------
DROP TABLE IF EXISTS `stocks_copy1`;
CREATE TABLE `stocks_copy1`  (
  `stock_id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `product_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `onhand_qty` float NULL DEFAULT NULL,
  `last_qty` float NULL DEFAULT NULL,
  `date_onhand_qty` datetime(0) NULL DEFAULT NULL,
  `date_last_qty` datetime(0) NULL DEFAULT NULL,
  ...
  INDEX `product_id`(`product_id`) USING BTREE,
  INDEX `branch_code`(`branch_code`) USING BTREE,
  CONSTRAINT `stocks_copy1_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `stocks_copy1_ibfk_2` FOREIGN KEY (`branch_code`) REFERENCES `md_branches` (`branch_code`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 23869 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
