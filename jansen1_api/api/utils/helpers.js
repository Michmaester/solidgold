...
const processReportTemplate = async (params) => {
    ...
    try {
        ...
        if (params.branch.branch_code === 'ATG') {
            report_meta['company_name'] = 'All Things Green by Homemaster'
            report_meta['address'] = 'Mandurriao, Iloilo City'
            report_meta['contact'] = 'Phone No. Tel Nos. - Fax No. Fax -'
        }
