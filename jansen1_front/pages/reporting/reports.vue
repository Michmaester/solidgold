<template>
	<div>
		...
		<div class="has-background-pageheader px-4 py-2 w-full flex items-center justify-between border-b border-gray-200 page-subheader">
			...
			<h3 class="has-text-header">All Reports</h3>
		...
		data() {
			return {
				...
				rept_templates: [
					...
					{ code: 'stocks', name: 'Stock Outs', rept_code: 'stock-outs', rept_tpl: 'stock_outs', filters: ['date', 'category'], orientation: 'portrait' },
					{ code: 'stocks', name: 'Stock Ins', rept_code: 'stock-ins', rept_tpl: 'stock_ins', filters: ['date', 'category'], orientation: 'portrait' },
